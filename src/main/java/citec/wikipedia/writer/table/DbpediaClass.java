...
import citec.wikipedia.writer.constants.AbstractCreateParameter;
 ...
 * @author elahi
 */
public class DbpediaClass implements AbstractCreateParameter {
    ...
    private void findPropertyEntities(String democraticJSON) throws FileNotFoundException, IOException, Exception {
        ...
        String jsonString = IOUtils.toString(inputStream, FileFolderUtils.UNICODE);
